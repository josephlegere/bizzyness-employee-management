...
export default {
  ...
  env: {
    ...
    SPECIALDATES_URL: process.env.SPECIALDATES_URL,
    ROOT_URL: process.env.ROOT_URL,
    ATTENDANCE: process.env.ATTENDANCE,
    ATTENDANCE_VERIFY: process.env.ATTENDANCE_VERIFY,
    ANTICIPATED_EMP: process.env.ANTICIPATED_EMP
  }
}
